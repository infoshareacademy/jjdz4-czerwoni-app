        ...
        <div class="row mt-3 pl-2 pr-2 pt-3 border border-secondary">
            <form method="post">
                <div class="questionForm">
                    ...
                    <label><fmt:message key="updateAll.questionLevel" bundle="${WDYWlanguage}"/> </label><br/><input size="20" name="questionLevel" type="text"
                ...
                <div class="questionForm">
                    ...
                    <select name="answer">
                        <option value="wybierz odpowiedź"><fmt:message key="updateAll.pickAnswer" bundle="${WDYWlanguage}"/></option>
                ...
                <c:forEach var="answerList" items="${sessionScope.question.answerList}">
                    <div class="questionForm">
                        <label><fmt:message key="updateAll.answer" bundle="${WDYWlanguage}"/> <input type="radio" name="questRadio" value="${answerList.answerId}"/>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <button class="button" type="submit" formaction="" name="edit-button" value="save-changes">
                            <fmt:message key="updateAll.saveChanges" bundle="${WDYWlanguage}"/>
                        </button>
                    </div>
                    <div class="col-lg-3">
                        <button class="button" type="submit" formaction="" name="edit-button" value="remove-answer">
                            <fmt:message key="updateAll.delPicked" bundle="${WDYWlanguage}"/>
                        </button>
                    </div>
                    <div class="col-lg-3">
                        <button class="button" type="submit" formaction="" name="edit-button" value="add-next-answer">
                            <fmt:message key="updateAll.addAnother" bundle="${WDYWlanguage}"/>
                        </button>
                    </div>
                    <div class="col-lg-3">
                        <button class="button" type="submit" formaction="admin-panel.jsp" name="edit-button"
                                value="back"><fmt:message key="updateAll.cancel" bundle="${WDYWlanguage}"/>Anuluj
                        </button>
                    </div>
                </div>
            </form>
