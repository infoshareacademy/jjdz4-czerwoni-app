                ...
                <form method="post" action="questions">
                    ...
                    <c:forEach var="list" items="${sessionScope.question.answerList}">
                        <c:if test="${list.answerId == selectedRadio}">
                            <div id="annswerName">
                                <label><input name="answerRadio" type="radio" value="${list.answerId}" checked/> ${list.answerName}</label><br/>
                            </div>
                        </c:if>
                        <c:if test="${list.answerId != selectedRadio}">
                            <div id="annswerName">
                                <label><input name="answerRadio" type="radio" value="${list.answerId}"/> ${list.answerName}<br/></label>
                            </div>
                        </c:if>
                    </c:forEach>
                    <div id="category">
