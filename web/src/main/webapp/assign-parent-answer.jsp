...
<div class="container">
    ...
    <div>
        <div class="row mt-3 pl-2 pr-2 pt-3 border border-secondary">
            <h4 id="questionTitle">Przypisz odpowiedź nadrzędną</h4><br/>
            <form class="questionForm" method="post" action="assign-parent-answer">
                <label>Treść pytania: </label><br/><input size="80" name="questionName" type="text" value="${sessionScope.question.questionName}"/> <br/><br/>
                <label>Poziom pytania: </label><br/><input size="20" name="questionLevel" type="text" value="${sessionScope.question.questionLevel}"/> <br /><br />
